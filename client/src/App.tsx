  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-6xl mx-auto">
          ...
          <div className="flex items-center gap-2">
            ...
            {isConnected && (
              <>
                ...
                <div
                  className={`w-3 h-3 rounded-full ${connectionState.whatsapp ? "bg-green-500" : "bg-yellow-500"}`}
                />
                <span className="text-sm text-gray-600">WhatsApp</span>
                <div className="w-px h-4 bg-gray-300 mx-2" />
                <div
                  className={`w-3 h-3 rounded-full ${connectionState.signal ? "bg-green-500" : "bg-yellow-500"}`}
                />
        ...
        <div className="mb-6 w-full h-16 bg-gray-200 rounded-lg flex items-center justify-center text-gray-400 text-sm border border-dashed border-gray-400">
          Advertisement
        </div>
        ...
        <div className="mt-6 w-full h-16 bg-gray-200 rounded-lg flex items-center justify-center text-gray-400 text-sm border border-dashed border-gray-400">
          Advertisement
        </div>
      </div>
    </div>
